...
def csv2dict(csvfile):
    ...
    return dict_list
dict_list_M=csv2dict('./item_listA_F.csv')
dict_list_G=csv2dict('./item_listO_AA_F.csv')
json_outp_M=[]
json_outp_G=[]
for item in dict_list_M:
    tmp_dict={}
    tmp_dict["instruction"]="""You will serve as an assistant to help me to extract a list of attributes of the following arts:(For example, when given \
...
for item in dict_list_G:
    tmp_dict={}
    tmp_dict["instruction"]="""You will serve as an assistant to help me to extract a list of attributes of the following office:(For example, when given \
